...
#
# 例:
#   python3 python/b15_Apply_X_To_Current_STIL.py 0 test_si 3
#
# 【注意】
# ・STIL全体は再生成しない
# ・指定 pattern ブロック内の test_si または _pi の値だけを置換する
# ・test_so, _po, end unload, コメント等は変更しない
# ・初回のみ ../b15/b15.stil を b15/b15_ET1.stil にコピーする
# =============================================================================
...
def main():
    if len(sys.argv) != 4:
        print(
            "Usage: python3 b15_Apply_X_To_Current_STIL.py <pattern_num> <test_si|pi> <bit_num>",
            file=sys.stderr
        )
        sys.exit(1)
